...
@InputType()
class ConfigurationCreateNestedManyWithoutDevicesInput {
...
export { ConfigurationCreateNestedManyWithoutDevicesInput as ConfigurationCreateNestedManyWithoutDevicesInput };
