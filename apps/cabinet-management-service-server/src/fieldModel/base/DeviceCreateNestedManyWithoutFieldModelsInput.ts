...
@InputType()
class DeviceCreateNestedManyWithoutFieldModelsInput {
...
export { DeviceCreateNestedManyWithoutFieldModelsInput as DeviceCreateNestedManyWithoutFieldModelsInput };
