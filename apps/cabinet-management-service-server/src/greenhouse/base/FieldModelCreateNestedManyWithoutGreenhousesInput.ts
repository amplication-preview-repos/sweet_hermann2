...
@InputType()
class FieldModelCreateNestedManyWithoutGreenhousesInput {
...
export { FieldModelCreateNestedManyWithoutGreenhousesInput as FieldModelCreateNestedManyWithoutGreenhousesInput };
