...
class GreenhouseCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FieldModelCreateNestedManyWithoutGreenhousesInput,
  })
  @ValidateNested()
  @Type(() => FieldModelCreateNestedManyWithoutGreenhousesInput)
  @IsOptional()
  @Field(() => FieldModelCreateNestedManyWithoutGreenhousesInput, {
    nullable: true,
  })
...
export { GreenhouseCreateInput as GreenhouseCreateInput };
